...
Binary files /dev/null and b/HelloWorld.svg.webp differ
[1mdiff --git a/README.md b/README.md[m
[1mdeleted file mode 100644[m
[1mindex 95c0e76..0000000[m
[1m--- a/README.md[m
[1m+++ /dev/null[m
[36m@@ -1,4 +0,0 @@[m
[31m-# hello-world[m
[31m-Hello World respository for Git tutorial[m
[31m-[m
[31m-CHRist is King.[m
[1mdiff --git a/hello-world-tutoGit.avif b/hello-world-tutoGit.avif[m
[1mnew file mode 100644[m
[1mindex 0000000..f9f2e5b[m
Binary files /dev/null and b/hello-world-tutoGit.avif differ
[1mdiff --git a/index.html b/index.html[m
[1mnew file mode 100644[m
[1mindex 0000000..ecd499e[m
[1m--- /dev/null[m
[1m+++ b/index.html[m
[36m@@ -0,0 +1,20 @@[m
...
[32m+[m[32m<div><img src = "hello-world-tutoGit.avif" alt = "Hello World  from Space"[m[41m [m
[32m+[m[32mstyle="width:100%;max-width:960px"></div>[m[41m  [m
[32m+[m[32m<p>This is the first file in my new Git Repo.</p>[m
[32m+[m[32m<<<<<<< HEAD[m
[32m+[m[32m<p>This line is here to show how merging works/p>[m
[32m+[m[32m=======[m
[32m+[m[32m<p>A new line in our file!</p>[m
[32m+[m[32m<div><img src = "HelloWorld.svg" alt = "Hello World  from Earth"[m[41m [m
[32m+[m[32mstyle="width:100%;max-width:640px"></div>[m[41m  [m
[32m+[m[32m>>>>>>> hello-world-images[m
[32m+[m[32m</body>[m
[32m+[m[32m</html>[m
\ No newline at end of file[m
[1mdiff --git a/t is King b/t is King[m
[1mnew file mode 100644[m
[1mindex 0000000..7ac7bed[m
[1m--- /dev/null[m
[1m+++ b/t is King[m	
[36m@@ -0,0 +1,335 @@[m
[32m+[m
...
[32m+[m[32m  ESC-j             *  Forward  one file line (or _N file lines).[m
[32m+[m[32m  ESC-k             *  Backward one file line (or _N file lines).[m
...
[32m+[m[32m  ESC-b             *  Backward one window, but don't stop at beginning-of-file.[m
...
[32m+[m[32m  ESC-f                Like F but ring the bell when search pattern is found.[m
...
[32m+[m[32m  ^O^N  ^On         *  Search forward for (_N-th) OSC8 hyperlink.[m
[32m+[m[32m  ^O^P  ^Op         *  Search backward for (_N-th) OSC8 hyperlink.[m
[32m+[m[32m  ^O^L  ^Ol            Jump to the currently selected OSC8 hyperlink.[m
...
[32m+[m[32m        ---------------------------------------------------[m
[32m+[m[32m        Search is case-sensitive unless changed with -i or -I.[m
...
[32m+[m[32m        ^S _n     Search for match in _n-th parenthesized subpattern.[m
[32m+[m[32m        ^W       WRAP search if no match found.[m
[32m+[m[32m        ^L       Enter next character literally into pattern.[m
[32m+[m[32m ---------------------------------------------------------------------------[m
[32m+[m
[32m+[m[32m                           JJUUMMPPIINNGG[m
[32m+[m
[32m+[m[32m  g  <  ESC-<  HOME *  Go to first line in file (or line _N).[m
[32m+[m[32m  G  >  ESC->  END  *  Go to last line in file (or line _N).[m
...
[32m+[m
[32m+[m[32m  m_<_l_e_t_t_e_r_>         *  Mark the top line (or line _N) with <letter>.[m
[32m+[m[32m  M_<_l_e_t_t_e_r_>         *  Mark the bottom line (or line _N) with <letter>.[m
[32m+[m[32m  '_<_l_e_t_t_e_r_>         *  Go to a previously marked position (put on position _N).[m
...
[32m+[m[32m  ^O^O                 Open the currently selected OSC8 hyperlink.[m
...
[32m+[m[32m  #_c_o_m_m_a_n_d             Execute the shell command, expanded like a prompt.[m
...
[32m+[m[32m                  Use a compiled lesskey file.[m
...
[32m+[m[32m                  Change handling of backspaces, tabs and carriage returns.[m
[32m+[m[32m  -V  ........  --version[m
[32m+[m[32m                  Display the version number of "less".[m
[32m+[m[32m  -w  ........  --hilite-unread[m
[32m+[m[32m                  Highlight first new line after full screen movement.[m
[32m+[m[32m  -W  ........  --HILITE-UNREAD[m
[32m+[m[32m                  Highlight first new line after any movement.[m
...
[32m+[m
[32m+[m[32m                --autosave=[_m_/_!_*][m
[32m+[m[32m                  Actions which cause the history file to be saved.[m
[32m+[m[32m                --emouse=[_v_s_c_r_o_l_l,_v_d_r_a_g,_h_s_c_r_o_l_l,_h_d_r_a_g,_l_c_l_i_c_k,_r_c_l_i_c_k][m
[32m+[m[32m                  Enable mouse features.[m
[32m+[m[32m                --end-prompt=[_s_t_r_i_n_g][m
[32m+[m[32m                  String to be printed after erasing the prompt.[m
[32m+[m[32m                --exit-follow-on-close[m
[32m+[m[32m                  Exit F command on a pipe when writer closes pipe.[m
...
[32m+[m[32m                --form-feed[m
[32m+[m[32m                  Stop scrolling when a form feed character is reached.[m
[32m+[m[32m                --header=[_L[,_C[,_N]]][m
[32m+[m[32m                  Use _L lines (starting at line _N) and _C columns as headers.[m
[32m+[m[32m                --hilite-target[m
[32m+[m[32m                  Highlight the target line.[m
[32m+[m[32m                --incsearch[m
[32m+[m[32m                  Search file as each pattern character is typed in.[m
[32m+[m[32m                --intr=[_C][m
[32m+[m[32m                  Use _C instead of ^X to interrupt a read.[m
[32m+[m[32m                --lesskey-context=_t_e_x_t[m
[32m+[m[32m                  Use lesskey source file contents.[m
[32m+[m[32m                --lesskey-src=_f_i_l_e[m
[32m+[m[32m                  Use a lesskey source file.[m
[32m+[m[32m                --line-num-width=[_N][m
[32m+[m[32m                  Set the width of the -N line number field to _N characters.[m
[32m+[m[32m                --match-shift=[_N][m
[32m+[m[32m                  Show at least _N characters to the left of a search match.[m
[32m+[m[32m                --modelines=[_N][m
[32m+[m[32m                  Read _N lines from the input file and look for vim modelines.[m
[32m+[m[32m                --mouse[m
[32m+[m[32m                  Enable mouse clicking and vertical scrolling.[m
[32m+[m[32m                --no-edit-warn[m
[32m+[m[32m                  Don't warn when using v command on a file opened via LESSOPEN.[m
...
[32m+[m[32m                --no-paste[m
[32m+[m[32m                  Ignore pasted input.[m
[32m+[m[32m                --no-search-header-lines[m
[32m+[m[32m                  Searches do not include header lines.[m
[32m+[m[32m                --no-search-header-columns[m
[32m+[m[32m                  Searches do not include header columns.[m
[32m+[m[32m                --no-search-headers[m
[32m+[m[32m                  Searches do not include header lines or columns.[m
[32m+[m[32m                --no-vbell[m
[32m+[m[32m                  Disable the terminal's visual bell.[m
[32m+[m[32m                --redraw-on-quit[m
[32m+[m[32m                  Redraw final screen when quitting.[m
[32m+[m[32m                --rscroll=[_C][m
...
[32m+[m[32m                --show-preproc-errors[m
[32m+[m[32m                  Display a message if preprocessor exits with an error status.[m
[32m+[m[32m                --past-eof[m
[32m+[m[32m                  Scrolling commands continue past end of file.[m
[32m+[m[32m                --proc-backspace[m
[32m+[m[32m                  Process backspaces for bold/underline.[m
[32m+[m[32m                --PROC-BACKSPACE[m
[32m+[m[32m                  Treat backspaces as control characters.[m
[32m+[m[32m                --proc-return[m
[32m+[m[32m                  Delete carriage returns before newline.[m
[32m+[m[32m                --PROC-RETURN[m
[32m+[m[32m                  Treat carriage returns as control characters.[m
[32m+[m[32m                --proc-tab[m
[32m+[m[32m                  Expand tabs to spaces.[m
[32m+[m[32m                --PROC-TAB[m
[32m+[m[32m                  Treat tabs as control characters.[m
[32m+[m[32m                --status-col-width=[_N][m
[32m+[m[32m                  Set the width of the -J status column to _N characters.[m
...
[32m+[m[32m                --wheel-lines=[_N][m
[32m+[m[32m                  Each click of the mouse wheel moves _N lines.[m
[32m+[m[32m                --wordwrap[m
[32m+[m[32m                  Wrap lines at spaces.[m
[32m+[m
[32m+[m
[32m+[m[32m ---------------------------------------------------------------------------[m
[32m+[m
